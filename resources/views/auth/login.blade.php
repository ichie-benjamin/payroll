...
<head>
    ...
    <link href="{{ asset('auth/css/simple-line-icons.css') }}" rel="stylesheet">
            ...
            <div class="card-group">
                ...
                <div class="card text-white bg-primary py-5 d-md-down-none" style="width:44%">
                    <div class="card-body text-center">
                        <div>
                            <img class="mt-4 mb-4"width="200px"src="{{ asset('auth/img/logo.png')}}" alt="" srcset="">
                            <p>PAYROLL-SYSTEM</p>
...
<script src="{{ asset('auth/js/vendor/jquery.min.js') }}"></script>
<script src="{{ asset('auth/js/vendor/popper.min.js') }}"></script>
